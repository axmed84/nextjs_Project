            ...
            <table className='min-w-full divide-y divide-gray-300'>
              <thead>
                <tr>
                  ...
                  text-gray-900 sm:pl-0'> Title</th>
                  <th scope='col' className='px-3 py-3.5 text-left text-sm font-semibold 
                  text-gray-900 sm:pl-0'> Body</th>
              ...
              <tbody className='divide-y divide-gray-200'>
                {
                  postsData.map(post => (
                    ...
                    <tr key={post.id}>
                      ...
                      text-gray-900 sm:pl-0'>{post.id}</td>
                      <td className='whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium 
                      text-gray-900 sm:pl-0'>{post.title}</td>
                      <td className='whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium 
                      text-gray-900 sm:pl-0'>{post.body}</td>

                      <td className='space-x-4 relative whitespace-nowrap py-4 pl-3 pr-4
                      text-right text-sm font-medium sm:pr-0'>
                        <DeleteButton id={post.id}/>
                        <Link href={`/posts/${post.id}`} className='text-indigo-600 hover:text-indigo-900'>
                        Edit  <span className='sr-only'>{post.name}</span></Link>
                      </td>
                    </tr>
                  ))
                }
